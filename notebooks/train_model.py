...
# Charger le dataset
df = pd.read_csv("C:/Users/barak/Documents/sensante/data/patients_dakar.csv")
...
#plt.tight_layout()
#plt.savefig('C:/Users/barak/Documents/sensante/figures/confusion_matrix.png', dpi=150)
#plt.show()
